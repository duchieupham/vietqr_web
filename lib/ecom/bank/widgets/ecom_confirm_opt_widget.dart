...
class ECOMConfirmOTPWidget extends StatefulWidget {
  final String requestId;
  final String phone;
  final ECOMBankBloc bankBloc;
  final BankCardRequestOTP dto;

  const ECOMConfirmOTPWidget({
    super.key,
...
class _ConfirmOTPWidget extends State<ECOMConfirmOTPWidget> {
                        ...
                        TextSpan(
                          ...
                          recognizer: TapGestureRecognizer()
                            ..onTap = () {
                              countdownProvider = CountdownProvider(120);
                              widget.bankBloc.add(
                                ECOMBankEventRequestOTP(dto: widget.dto),
                              );
                              Navigator.pop(context);
                            },
                        ),
          ...
          child: ButtonWidget(
            ...
            function: () {
              if (otpController.text.isNotEmpty) {
                ...
                widget.bankBloc.add(ECOMBankEventConfirmOTP(dto: confirmDTO));
              }
            },
          ),
        ),
