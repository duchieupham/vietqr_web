...
class DialogEditNoteStoreWidget extends StatefulWidget {
  final Function(TransactionStoreDTO) update;
  final TransactionStoreDTO dto;

  const DialogEditNoteStoreWidget(
      {super.key, required this.update, required this.dto});

  @override
  State<DialogEditNoteStoreWidget> createState() =>
      _DialogUpdateNoteWidgetState();
}

class _DialogUpdateNoteWidgetState extends State<DialogEditNoteStoreWidget> {
  final _valueController = TextEditingController();
  String _value = '';
  TransactionStoreDTO dto = TransactionStoreDTO();
                          ...
                          Expanded(
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  child: _buildListHasTag(hasTagOutCome),
                                )
                              ],
                            ),
                          ),
