...
class QRRechargeFrame extends StatefulWidget {
  final Widget widget1;
  final Widget widget2;
  // final Widget widget3;

  const QRRechargeFrame({
    super.key,
  ...
  @override
  State<QRRechargeFrame> createState() => _HomeFrameState();
}

class _HomeFrameState extends State<QRRechargeFrame> {
                              ...
                              children: [
                                ...
                                Expanded(
                                  ...
                                  children: [
                                    ...
                                    Expanded(flex: 5, child: widget.widget2),
                                    const SizedBox(width: 30),
                                    const Spacer(),
