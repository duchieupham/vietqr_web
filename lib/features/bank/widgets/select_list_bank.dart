...
class ListBankTypeWidget extends StatelessWidget {
  ...
  static List<BankTypeDTO> bankTypesResult = [];
  static List<BankTypeDTO> bankTypes = [];
  static late BankTypeBloc bankTypeBloc;
  const ListBankTypeWidget({super.key, required this.listBank});
