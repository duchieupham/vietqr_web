  ...
  Widget _buildFormInput() {
    return Row(
      ...
      children: [
        ...
        Consumer<CreateQRLoginProvider>(builder: (context, provider, child) {
          return Expanded(
            child: Column(
              children: [
                Row(
                              ...
                              child: ListView(
                                ...
                                children: [
                                  ...
                                  BlocConsumer<BankTypeBloc, BankTypeState>(
                                      listener: (context, state) {
                                    if (state
                                        is BankTypeGetListSuccessfulState) {
                                      bankTypes = state.list;
                                    }
                                  }, builder: (context, state) {
                                  ...
                                  if (provider.showMoreOption) ...[
                                          ...
                                          if (amountController
                                            ...
                                            if (StringUtils.instance.isNumeric(
                                              ...
                                              if (amountController
                                                  ...
                                                  4) {
                                                provider
                                                    .updateValidCreate(true);
                                              } else {
                                                provider
                                                    .updateValidCreate(false);
                                              }
                                            } else {
                                    ...
                                    BorderLayout(
                                      ...
                                      child: TextFieldWidget(
                                        ...
                                        fontSize: 14,
                                        hintText:
                                            'Nội dung không được quá 50 kí tự',
