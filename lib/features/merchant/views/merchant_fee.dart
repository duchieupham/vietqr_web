...
class MerchantFee extends StatefulWidget {
  const MerchantFee({super.key});

  @override
  State<MerchantFee> createState() => _MerchantViewState();
}

class _MerchantViewState extends State<MerchantFee> {
        ...
        child: SizedBox(
          ...
          child: Column(
            children: [
              ...
              const Expanded(child: ServiceFee())
            ],
          ),
        ),
      ),
