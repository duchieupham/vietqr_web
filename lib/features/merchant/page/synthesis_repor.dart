      ...
      child: Row(
        children: [
          ...
          _buildBoxItem('${StringUtils.formatNumber(dto.totalAmount)} VND',
              width: 160),
          _buildBoxItem(
            dto.totalCredit.toString(),
            width: 100,
          ),
          _buildBoxItem(
            dto.totalDebit.toString(),
            width: 100,
          ),
          _buildBoxItem('${StringUtils.formatNumber(dto.totalTransC)} VND',
              width: 160),
          _buildBoxItem('${StringUtils.formatNumber(dto.totalTransD)} VND',
              width: 160),
        ],
      ),
    );
